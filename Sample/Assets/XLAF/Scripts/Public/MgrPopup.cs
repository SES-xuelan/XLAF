...
namespace XLAF.Public
{
    ...
    public class MgrPopup : MonoBehaviour
    {
        ...
        public static void Show(SceneParams par)
        {
            ...
            switch (anim)
            {
                ...
                case SceneAnimation.diy:
                    _instance._AnimationDiy(true, sceneName, data, bgAlpha, diyNewAction, cb);
                    break;
            }
        ...
        public static void Hide(SceneParams par)
        {
            ...
            switch (anim)
            {
                ...
                case SceneAnimation.zoomOut:
                    ...
                    break;
                case SceneAnimation.diy:
                    _instance._AnimationDiy(false, sceneName, data, bgAlpha, diyOldAction, cb);
                    break;
            }
        ...
        private void _AnimationDiy(bool isShow, string sceneName, object data, float bgAlpha, Action<SceneObject, Action> sceneAnim, Action cb)
        {
            if (sceneAnim == null)
            {
                _AnimationNone(isShow, sceneName, data, 0.8f, cb);
                return;
            }
